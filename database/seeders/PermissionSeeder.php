...
final class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'club.mercado_pago.view', 'description' => 'Consultar el estado de conexión con Mercado Pago'],
            ...
            ['name' => 'membership.view', 'description' => 'Ver membresías de un club o sucursal'],
            ...
            ['name' => 'court_interval.view', 'description' => 'Ver el intervalo de turnos por tipo de cancha'],
            ['name' => 'court_interval.update', 'description' => 'Modificar el intervalo de turnos por tipo de cancha'],
            ...
            ['name' => 'dashboard.view', 'description' => 'Ver métricas operativas de una sucursal'],
        ];
