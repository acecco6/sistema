...
final class EloquentPaymentRepository implements PaymentRepository
{
    ...
    public function sumApprovedByReservation(
        int $reservationId
    ): string {
        ...
        return new PaymentEntity(
            ...
            paidAt: $model->paid_at
                ? new DateTimeImmutable(
                    $model->paid_at->format(
                        'Y-m-d H:i:s'
                    )
                )
                : null,

            mercadoPagoAccountId: $model->mercado_pago_account_id
                !== null
                ? (int) $model->mercado_pago_account_id
                : null,
        );
    }
}
